...
export const step21 = {
  ...
  description: `Now, let's add a new vector (the orange line) and calculate the dot product for the orange and purple line, and the dot product for the orange and yellow line. Let's say the orange line is the vector $\\vec{v_{orange}} = (-60, 150)$.`,
